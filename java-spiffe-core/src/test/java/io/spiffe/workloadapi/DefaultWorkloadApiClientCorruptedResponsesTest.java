...
class DefaultWorkloadApiClientCorruptedResponsesTest {
    ...
    void setUp() throws IOException {
        workloadApiClient = WorkloadApiClientTestUtil.create(new FakeWorkloadApiCorruptedResponses(), grpcCleanup);
    }
